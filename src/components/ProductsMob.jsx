...
const ProductsMob = () => {
  ...
  const closeModal = (e) => {
    if (e && e.target === modalRefs.current) {
      setShowModal(false);
    }
  };
              ...
              >
                    ...
                    <SwiperSlide className="rounded-t-3xl">
                      <div className=" h-32 w-full flex justify-center items-center">
                        <img
                          ...
                          alt="productImage"
                          onClick={() => {
                            closeModal, setShowModal(true), setId(product.id),console.log('test');
                          }}
                        />
                ...
                <div className={` text-center text-black 2xl:text-lg text-sm h-32 2xl:h-40 w-full rounded-b-lg pb-5   flex flex-col  gap-2 py-2`}>
                  <div className="mx-4 flex flex-col justify-center items-center gap-1   text-sm">
                    ...
                    <h2 className={`font-semibold ${product.bg}  text-center m-4 px-4 text-white p-1`}>{product.use}</h2>
                  </div>
