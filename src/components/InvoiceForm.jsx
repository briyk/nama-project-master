...
const InvoiceForm = () => {
  ...
  const [invoiceNumber, setInvoiceNumber] = useState(getRandomInvoiceNumber()); // Initialize with a random invoice number
  ...
  return (
    ...
    >
      <div className="my-6 flex-1 space-y-2  rounded-md bg-white p-4 shadow-sm sm:space-y-4 md:p-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-2 pt-4 pb-2">
          <label
        ...
        <table className="w-full p-4 text-right">
          <thead dir='rtl'>
