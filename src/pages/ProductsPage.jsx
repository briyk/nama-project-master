  ...
  return (
    <div id="products">
      ...
      <div className="2xl:mx-20 mx-12 max-m-8 mt-[100px] md:mt-[120px] ">
        <div className="flex justify-start md:justify-end mt-36  items-baseline gap-4 max-sm:my-5 mx-20 ">
          <h1 className="text-3xl  font-bold text-[#FF7315] max-sm:text-2xl">منتجاتنا</h1>
          <span>
            <FaLessThan />
          </span>
